...
interface TagBadgeProps {
  readonly id: string; // Using string to allow permissive usage, but logically it should be TagId
}

export const TagBadge: React.FC<TagBadgeProps> = ({ id }) => {
  const metadata = getTagMetadata(id as TagId);
  ...
  const style = variantStyles[metadata.color || 'default'];
