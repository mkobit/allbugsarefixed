...
// harness (no @testing-library/react, the unit test runner only picks up
// src/**/*.test.ts, and its transform pipeline has no JSX plugin), so logic
// that needs unit coverage stays out of .tsx files.
