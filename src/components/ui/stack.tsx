...
export function Stack({ className, align, direction, gap, justify, as: Component = 'div', ...props }: Readonly<StackProps>) {
  return (
    <Component className={cn(stackStyles({ align, direction, gap, justify }), className)} {...props} />
  );
}
