...
Render icons inline with text by adjusting `className` properties. For example, <Cpu className="inline-block w-4 h-4 text-red-500 align-middle" /> **CPU Usage** or <Globe className="inline-block w-4 h-4 text-blue-400 align-middle" /> **Network Status**.
