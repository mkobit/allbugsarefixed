## Purpose
Define the reading-aid widgets available to blog posts and how each is authored: markdown syntax where the ecosystem already provides correct, accessible output (footnotes), or a client-side behavior enhancement on top of an existing static feature (table-of-contents active-heading indication).
